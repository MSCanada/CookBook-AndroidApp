CookBook is a simple useful android application which allow user to browse through different recipes. This application has some extra features which are listed as follows:
